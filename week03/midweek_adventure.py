...
if choice1 == "match":
    ...
    choice2 = input("Type RUN or HIDE: ").strip().lower()
    ...
    print("Do you want to FOLLOW the path or LOOK in the trees for the thing that made the noise?")
    choice2 = input("Type FOLLOW or LOOK: ").strip().lower()
